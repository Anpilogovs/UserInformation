...
final class EditingTableView: UITableView {
    ...
    override init(frame: CGRect, style: UITableView.Style) {
        ...
        register(DatePickerTableViewCell.self.self, forCellReuseIdentifier: DatePickerTableViewCell.idDatePickerCell)
        register(PickerViewTableViewCell.self.self, forCellReuseIdentifier: PickerViewTableViewCell.idPickerViewCell)
